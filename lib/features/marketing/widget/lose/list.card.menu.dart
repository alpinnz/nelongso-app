...
class ListCardMenu extends StatelessWidget {
  final List<LoseMenuModel> model;
  final int year;
  final int month;
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, LoseMenuModel _data) async {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Container(
            ...
            child: ListTile(
              title: Text(_convertToKapital('${dataSelected.menu}')),
              subtitle:
                  Text(_convertToKapital('${dataSelected.jumlahQtyLoseSale}')),
