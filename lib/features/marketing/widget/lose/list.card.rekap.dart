...
class ListCardRekap extends StatelessWidget {
  final List<LoseRekapModel> model;
  final int year;
  final int month;

  const ListCardRekap({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, LoseRekapModel _data) async {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Container(
            ...
            child: ListTile(
              title: Text(_convertToKapital('${dataSelected.nama}')),
              subtitle: Text(_convertToKapital('${dataSelected.code}')),
