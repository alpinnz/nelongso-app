...
class ListCardRegional extends StatelessWidget {
  final List<PotensialRegionalModel> model;
  final int year;
  final int month;

  const ListCardRegional({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, PotensialRegionalModel _data) async {
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Container(
            ...
            child: ListTile(
              ...
              subtitle: Text(_convertToKapital('outlet')),
