...
class ListCardBasket extends StatelessWidget {
  final List<KetercapaianBasketModel> model;
  final int year;
  final int month;

  const ListCardBasket({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, KetercapaianBasketModel _data) async {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Container(
            ...
            child: ListTile(
              title: Text(_convertToKapital('${dataSelected.namaOutlet}')),
              subtitle: Text(_convertToKapital('${dataSelected.regional}')),
