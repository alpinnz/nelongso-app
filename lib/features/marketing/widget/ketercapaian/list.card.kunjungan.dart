...
class ListCardKunjungan extends StatelessWidget {
  final List<KetercapaianKunjunganModel> model;
  final int year;
  final int month;

  const ListCardKunjungan({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(
        BuildContext context, KetercapaianKunjunganModel _data) async {
