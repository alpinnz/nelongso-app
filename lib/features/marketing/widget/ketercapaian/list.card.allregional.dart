...
class ListCardAllregional extends StatelessWidget {
  final List<KetercapaianAllregionalModel> model;
  final int year;
  final int month;

  const ListCardAllregional({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(
        BuildContext context, KetercapaianAllregionalModel _data) async {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Container(
            ...
            child: ListTile(
              title: Text(_convertToKapital('${dataSelected.no}')),
