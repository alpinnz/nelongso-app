...
class ListCardSelisih extends StatelessWidget {
  final List<KetercapaianSelisihModel> model;
  final int year;
  final int month;

  const ListCardSelisih({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(
        BuildContext context, KetercapaianSelisihModel _data) async {
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Container(
            ...
            child: ListTile(
              ...
              subtitle: Text(_convertToKapital('${dataSelected.selisih}')),
