...
class ListCard extends StatelessWidget {
  final List<AnalyticsModel> model;
  final int year;
  final int month;

  const ListCard({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, AnalyticsModel _data) async {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Container(
            ...
            child: ListTile(
              title: Text(_convertToKapital('${dataSelected.outletName}')),
