...
class ListCardOmzetyear extends StatelessWidget {
  final List<TrendOmzetYearModel> model;
  final int year;
  final int month;

  const ListCardOmzetyear({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, TrendOmzetYearModel _data) async {
