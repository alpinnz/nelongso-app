...
class ListCardFinal extends StatelessWidget {
  final List<AllregionalFinalModel> model;
  final int year;
  final int month;

  const ListCardFinal({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, AllregionalFinalModel _data) async {
