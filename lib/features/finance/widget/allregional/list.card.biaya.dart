...
class ListCardBiaya extends StatelessWidget {
  final List<AllregionalBiayaModel> model;
  final int year;
  final int month;

  const ListCardBiaya({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, AllregionalBiayaModel _data) async {
