...
class ListCardWeak extends StatelessWidget {
  final List<AllregionalWeakModel> model;
  final int year;
  final int month;

  const ListCardWeak({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, AllregionalWeakModel _data) async {
