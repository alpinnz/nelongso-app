...
class ListCardShare extends StatelessWidget {
  final List<AllregionalShareModel> model;
  final int year;
  final int month;

  const ListCardShare({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, AllregionalShareModel _data) async {
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Container(
            ...
            child: ListTile(
              ...
              subtitle: Text(_convertToKapital('${dataSelected.outlet}')),
