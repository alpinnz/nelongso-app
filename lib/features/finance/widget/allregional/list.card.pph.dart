...
class ListCardPph extends StatelessWidget {
  final List<AllregionalPphModel> model;
  final int year;
  final int month;

  const ListCardPph({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, AllregionalPphModel _data) async {
