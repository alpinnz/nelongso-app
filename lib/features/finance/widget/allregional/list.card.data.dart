...
class ListCardData extends StatelessWidget {
  final List<AllregionalDataModel> model;
  final int year;
  final int month;

  const ListCardData({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, AllregionalDataModel _data) async {
