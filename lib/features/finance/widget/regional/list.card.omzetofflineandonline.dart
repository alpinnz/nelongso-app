...
class ListCardOmzetofflineandonline extends StatelessWidget {
  final List<RegionalOmzetofflineandonlineModel> model;
  final int year;
  final int month;

  const ListCardOmzetofflineandonline(
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(
        BuildContext context, RegionalOmzetofflineandonlineModel _data) async {
      List<DataRow> listDataTable = _data.data.map(
        (e) {
          var dataRow = DataRow(
            cells: <DataCell>[
              DataCell(Text('${e.id}')),
              DataCell(Text('${e.offline}')),
            ],
          );
          return dataRow;
        },
