...
class ListCardGojekandgrab extends StatelessWidget {
  final List<NoncashGojekandgrabModel> model;
  final int year;
  final int month;

  const ListCardGojekandgrab({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(
        BuildContext context, NoncashGojekandgrabModel _data) async {
      ...
      List<ChartItemModel> _dataChartItem = [
        ...
        ChartItemModel(
          ...
          chartItem: _data.data
              .map((e) => ChartItem(
                  date: DateTime(year, month, int.parse(e.id)),
                  value: double.parse(e.setoranBersih)))
              .toList(),
        )
      ];
            ...
            child: Column(
              children: [
                Padding(
                  ...
                  child: Text('Pendapatan Ovo 85% & Gopay 85%'),
                ),
                Container(
