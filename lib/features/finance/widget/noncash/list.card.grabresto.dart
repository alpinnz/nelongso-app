...
class ListCardGrabresto extends StatelessWidget {
  final List<NoncashGrabrestoModel> model;
  final int year;
  final int month;

  const ListCardGrabresto({Key key, this.model, this.year, this.month})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void _barWidget(BuildContext context, NoncashGrabrestoModel _data) async {
